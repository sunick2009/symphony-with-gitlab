defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Codex do
    ...
    embedded_schema do
      ...
      field(:health_check_command, :string)
    end
  ...
  defmodule Hooks do
    ...
    def changeset(schema, attrs) do
      schema
      |> cast(attrs, [:after_create, :before_run, :before_turn, :after_turn, :after_run, :before_remove, :timeout_ms], empty_values: [])
